    ...
    <div className=" max-w-7xl mx-auto">
      ...
      >
        ...
        <div className="p-6">
          <h6
            style={{ backgroundColor: card_bg }}
            className="mb-4 block w-[50%] text-center font-sans text-base font-bold capitalize leading-relaxed tracking-normal antialiased"
          >
          ...
          <p
            style={{ color: text_bg }}
            className="mb-8 block font-sans text-lg font-bold leading-relaxed text-gray-700 antialiased"
          >
            ${price}.00
          </p>
